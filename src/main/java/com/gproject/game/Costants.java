...
public class Costants {
    ...
    public static final int P_CHARGES = 10;
    ...
    public static final int G_VELOCITY_LIMIT_X = 500;    // Limite di velocità massimo per evitare movimenti troppo rapidi e poco controllabili.
